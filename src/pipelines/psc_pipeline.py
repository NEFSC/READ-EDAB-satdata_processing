...
if __name__ == "__main__":
    args = parse_args()
    run_psc_pipeline(chl_dataset=args.chl_dataset, sst_dataset=args.sst_dataset, subset=args.subset, daterange=args.daterange, logfile=args.logfile, verbose=args.verbose)
